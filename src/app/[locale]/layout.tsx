...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "url shortener",
      "perpendek link",
      "hasilkan uang dari link",
      "shortlinkmu",
      "link shortener Indonesia",
      "pemendek url",
      "shorten link gratis",
      "monetize link",
      "earn money from links",
    ],

    authors: [{ name: "Shortlinkmu", url: "https://shortlinkmu.com" }],
    creator: "Shortlinkmu",
    publisher: "Shortlinkmu",
