...
const steps = [
  ...
  },
  {
    number: "02",
    title: "Shorten Links",
    desc: "Create monetized short URLs",
    color: "from-bluelanding to-purple-600",
    // Link icon for background
    bgIcon: (
      <svg className="w-full h-full" viewBox="0 0 24 24" fill="currentColor">
    ...
    content: (
      <div className="space-y-2.5">
        ...
        <div className="h-8 bg-white/20 border border-white/30 rounded-lg flex items-center justify-between px-3">
          <span className="text-xs font-medium text-white">slmu.my.id/x7k</span>
          <svg
        ...
        <div className="flex gap-2">
          <div className="flex-1 h-6 bg-white/10 rounded flex items-center justify-center">
            <span className="text-[9px] text-white/60">2.4K clicks</span>
          </div>
          <div className="flex-1 h-6 bg-white/10 rounded flex items-center justify-center">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12 md:mb-16">
          <div>
            ...
            >
              How It <span className="text-bluelanding">Works</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
